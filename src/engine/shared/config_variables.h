...
MACRO_CONFIG_STR(Bindaddr, bindaddr, 128, "", CFGFLAG_CLIENT|CFGFLAG_MASTER, "Address to bind the client/server to")
...
MACRO_CONFIG_INT(SvMaxClientsPerMap, sv_max_clients_per_map, 64, 1, MAX_CLIENTS, CFGFLAG_SERVER, "Maximum number of clients that are allowed on a map")
...
MACRO_CONFIG_INT(SrvAutoThrottle, sv_auto_throttle, 200, 0, 9999999, CFGFLAG_SERVER, "Automaticly keeps the srv at a custom tick frequenze")
...
MACRO_CONFIG_INT(DbgDatabase, dbg_database, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SERVER, "Debug mode for database")
MACRO_CONFIG_INT(DbgGame, dbg_game, 0, 0, 1, CFGFLAG_SERVER, "Debug mode for game")
MACRO_CONFIG_INT(DbgStress, dbg_stress, 0, 0, 0, CFGFLAG_CLIENT|CFGFLAG_SERVER, "Stress systems")
MACRO_CONFIG_INT(DbgStressNetwork, dbg_stress_network, 0, 0, 0, CFGFLAG_CLIENT|CFGFLAG_SERVER, "Stress network")
MACRO_CONFIG_INT(DbgPerf, dbg_perf, 0, 0, 1, CFGFLAG_SERVER, "Performance outputs")
